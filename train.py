...
def infer(nlu1,
    ...
    model.eval()
    model_bert.eval()
    engine = DBEngine(f"C:/Users/sakshi/Downloads/NLP-SQL-Bert/data_and_model/{db_name}.db")
    #engine = DBEngine(os.path.join(path_db, f"C:/Users/sakshi/Downloads/NLP-SQL-Bert/data_and_model/{dset_name}.db"))
...
if __name__ == '__main__':
    ...
    if args.do_infer:
        ...
        db_name = 'test'
        data_table = load_jsonl('./data_and_model/test.tables.jsonl')
        table_name = 'table_1_10015132_16'
